-- https://github.com/OpenPrograms/Saphire-Programs/blob/master/ytdl.lua
...
local base_site = "http://change.to.your.server"
local base_bitrate = 32
local base_conv_url = base_site .. "/get"
